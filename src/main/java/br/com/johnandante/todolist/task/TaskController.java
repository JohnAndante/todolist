package br.com.johnandante.todolist.task;
...
import br.com.johnandante.todolist.utils.Utils;
...
public class TaskController {
  ...
  public ResponseEntity update(@RequestBody TaskModel taskModel, HttpServletRequest request, @PathVariable UUID id) {
    ...
    if(!task.getIdUser().equals(idUser)) {
      return ResponseEntity.status(401).body("Usuário não autorizado para alterar esta tarefa.");
    }
